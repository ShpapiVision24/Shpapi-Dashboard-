...
.kpi-value {{ font-size: 2rem; font-weight: 700; color: {GOLD}; letter-spacing: -1px; line-height: 1; }}
...
.stat-value {{ font-size: 1.15rem; font-weight: 600; color: {GOLD}; letter-spacing: -0.3px; line-height: 1; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }}
...
_NAV_ACTIVE = f"padding:0.35rem 0.9rem;border-radius:6px;font-size:0.8rem;font-weight:700;color:{GOLD};background:rgba(59,130,246,0.18);text-decoration:none;white-space:nowrap;"
...
with _c_nav:
    ...
    <div style="display:flex;align-items:center;gap:0.15rem;padding-top:1.1rem;">
      ...
      <a href="/Meta_Ads" target="_self" style="{_NAV_ACTIVE}">Meta Ads</a>
      <a href="/Shopify" target="_self" style="{_NAV_LINK}">Shopify</a>
      <a href="/Google_Ads" target="_self" style="{_NAV_LINK}">Google Ads</a>
    </div>
    """, unsafe_allow_html=True)
